...
Production_electricity_cost <- read_excel("~/WORK_PROJECTS/Iwb/IWB/Results_Final/R_data/Sensitivity/Sensitivity_1B_Case1/Production_electricity_cost.xlsx")

Production_electricity_carbon <- read_excel("~/WORK_PROJECTS/Iwb/IWB/Results_Final/R_data/Sensitivity/Sensitivity_1B_Case1/Production_electricity_carbon.xlsx")
...
df[df$variable != 'Demand + HPs + E-Mobility' & df$Case =='Case1',]$cat <- "P C1"
df[df$variable == 'Demand + HPs + E-Mobility' & df$Case =='Case1',]$cat <- "D C1"
...
p4<-ggplot(data=df, aes(x = cat, y = value, fill=factor(variable, levels=c("Grid Import","Hydroelectricity CH",
  ...
  labs(x="",y="GWh/year") + scale_x_discrete(limits = c("D BC","P BC","D C1","P C1")) +
...
Production_heat_cost <- read_excel("~/WORK_PROJECTS/Iwb/IWB/Results_Final/R_data/Sensitivity/Sensitivity_1B_Case1/Production_heat_cost.xlsx")

Production_heat_carbon <- read_excel("~/WORK_PROJECTS/Iwb/IWB/Results_Final/R_data/Sensitivity/Sensitivity_1B_Case1/Production_heat_carbon.xlsx")
...
df[df$variable != 'Heat demand' & df$Case =='Case1',]$cat <- "P C1"
df[df$variable == 'Heat demand' & df$Case =='Case1',]$cat <- "D C1"
